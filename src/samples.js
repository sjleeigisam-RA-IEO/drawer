  ...
  },
  {
    ...
    model: {
      ...
      plan: {
        ...
        areaBasisNote: "준공 PDF 평면도에서 샘플링한 외곽 229.3m x 92m, 도크 치수 기반 검토용 산정",
        areaZones: [
          {
            id: "gangnam-floor-gross",
            name: "전체 바닥 영역",
            type: "gross",
        ...
        gridZ: [-36, -18, 0, 18, 36],
        core: { x: -84, z: -23, width: 20, depth: 16, elevators: 2, stairs: 2, risers: 4, provenance: "assumption", visible: false },
        dockDoors: 24,
        rackRows: 8
      },
      levels: [
  ...
  },
  {
    ...
    model: {
      ...
      plan: {
        ...
        areaBasisNote: "준공 PDF 평면도에서 샘플링한 외곽 188m x 84m, 도크 치수 기반 검토용 산정",
        areaZones: [
          {
            id: "dongsan-floor-gross",
            name: "전체 바닥 영역",
            type: "gross",
            levelIds: ["b1", "warehouse1", "warehouseUpper"],
            points: [
        ...
        gridZ: [-32, -16, 0, 16, 32],
        core: { x: -68, z: -18, width: 18, depth: 15, elevators: 2, stairs: 2, risers: 4, provenance: "assumption", visible: false },
        dockDoors: 20,
        rackRows: 7
      },
      levels: [
